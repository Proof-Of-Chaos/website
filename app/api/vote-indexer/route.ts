...
import { getUserVotesIndexer } from "./get-user-votes-indexer";
...
export async function POST(req: NextRequest) {
  ...
  console.log("server route /api/vote-indexer", chain, referendaFilter);
  ...
  result = await getUserVotesIndexer(chain, userAddress, referendaFilter);
