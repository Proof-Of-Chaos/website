...
import { NftStats } from "../components/nft/nft-stats";
...
function Home({ nfts }) {
  return (
    <>
      <NextSeo title="Home" />
      <section className="h-auto relative overflow-hidden">
        <div className="relative px-6 py-20 sm:px-10 mb-10 overflow-visible">
          <div className="relative z-10 mx-auto py-3 text-left md:text-center max-w-screen-xl overflow-hidden pointer-events-none">
            <h1 className="z-90 mb-6 text-4xl font-extrabold max-w-5xl mx-auto tracking-normal text-gray-900 sm:text-6xl md:text-6xl lg:text-7xl md:tracking-tight lg:leading-tight">
              {" "}
              We{" "}
              <span className="w-full text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 lg:inline">
                incentivize voting
              </span>{" "}
              to decentralize Kusama
            </h1>
            <p className="px-0 mb-12 text-lg text-gray-600 md:text-xl lg:px-24">
              Send customizable NFTs to voters with just a few clicks.
            </p>
        ...
        <div className="px-4 py-12 mx-auto text-center lg:px-36">
          <span className="font-semibold text-gray-400 uppercase block pb-6">
            Numbers
          </span>
          <NftStats priceFeeds={nftFeedData} />
          <a
            target="_blank"
            rel="noreferrer"
            href="https://app.web3go.xyz/#/NftDetail?id=3208723ec6f65df810-ITEM"
      ...
      <section className="w-full flex py-20 px-5 sm:px-10 md:px-5">
        <div className="max-w-6xl mx-auto border-t md:py-8 py-8 sm:py-10 px-8 sm:px-12 flex md:flex-row flex-col p-4">
          <div className="md:w-1/2 flex flex-col items-center md:max-w-full md:mx-0 mx-auto max-w-sm md:items-start md:text-left text-left sm:text-center justify-center">
            <h2 className="font-black text-2xl sm:text-3xl w-full">
              Our Mission
            </h2>
            <p className="text-gray-500 sm:text-base text-sm mb-5 mt-4">
              ...
              designed a system where we incentivise tokenholders to participate
          ...
          <div className="md:w-1/2 w-full flex justify-end">
            <svg
              className="max-w-fit px-10 py-4"
            ...
            >
              ...
              <g id="b6a4aa65-5bff-4dd4-a595-827386906092" data-name="woman">
                ...
                />
                <path
                  id="ac286760-ef31-4470-8aba-995faff60c3b-244"
                ...
                />
                <path
                  id="ad0ee0d5-d520-47bd-bca9-706ef112ee3c-245"
                  data-name="left leg"
                ...
                />
                <path
                  id="a2d865fc-f989-4a0f-bdfe-5d1a04b5cb09-246"
                  data-name="left shoe"
                ...
                />
                <path
                  id="a5afd73e-dc2f-49f8-bb76-01b6bc8ff4ec-247"
                  data-name="right leg"
                ...
                />
                <path
                  id="bae9c969-98bd-41cd-ab49-dced4866e2f9-248"
                ...
                />
                <path
                  id="efa1face-c8d6-4f61-8a17-c81461288bfc-249"
                  data-name="pants"
                ...
                />
                <path
                  id="ba787e0e-2496-4127-9664-864bc1f1b460-250"
                  data-name="left hand"
                ...
                />
                <path
                  id="fc691572-079c-4ac7-a111-0c7206f484e6-251"
                  data-name="neck"
                ...
                />
                <path
                  id="a377c2ac-5aad-4dd5-94e4-d6887260be3a-252"
                ...
                />
                <path
                  id="fd50713a-8150-4e39-832b-91f38638a5e4-253"
                  data-name="left arm"
                ...
                />
                <path
                  id="a85ddca5-281c-4897-a8aa-82a4133bac02-254"
                  data-name="right arm"
                ...
                />
                <path
                  id="eb14ef5a-0bc4-48da-8b11-b0e113a7ef46-255"
                  data-name="hair"
